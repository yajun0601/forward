...
def default_sample():
    code = db.default_ratios.find({'$and' :[{'INDUSTRY_CSRC12':'金融业'},{"rptDate" : "20151231"}]},{'_id':0,'code':1,'COMP_NAME':1}) #,'COMP_NAME':1
...
#shape(report2015)
#shape(report2016)
query = db.default_ratios.find({'$and' :[{'INDUSTRY_CSRC12':'金融业'},{"rptDate" : "20141231"}]},{'_id':0,'code':1})
...
query = db.default_ratios.find({'$and' :[{'INDUSTRY_CSRC12':'金融业'},{"rptDate" : "20151231"}]},{'_id':0,'code':1,'COMP_NAME':1}) #,'COMP_NAME':1
